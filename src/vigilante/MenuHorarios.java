...
public class MenuHorarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnGestionarEntrada.setText("Registrar Horarios");
        ...
        btnVisEntrada.setText("Visualizar Horarios");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuHorarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuHorarios().setVisible(true);
            }
        });
    }
