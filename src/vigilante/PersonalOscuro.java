 ...
 * @author CRISTIAN
 */
public class PersonalOscuro extends javax.swing.JFrame {

    /**
     * Creates new form PersonalOscuro
     */
    public PersonalOscuro() {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Identificación", "Nombre", "Apellido", "Salario", "DUI", "Correo Electornico", "Estado del Vigilante", "Tipo de Personal"
            }
        ));
        ...
        jPanel4.add(jPanel5);
        jPanel5.setBounds(20, 10, 1040, 680);

        getContentPane().add(jPanel4);
        jPanel4.setBounds(290, 40, 1100, 730);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PersonalOscuro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PersonalOscuro().setVisible(true);
            }
        });
    }
