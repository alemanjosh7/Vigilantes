...
import FormsVigilante.FrmVisualizarReporteVigilantes;
...
public class FrmVisualizarPersonal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPSideBar.setBounds(0, 0, 290, 796);
        ...
        jPContainer.setBounds(290, 60, 1080, 680);
        ...
        jPToolStrip.setBounds(288, 0, 1080, 61);
    ...
    private void jFTBusquedaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jFTBusquedaKeyTyped
        if(!SoloLetra(evt.getKeyChar()) && !SoloSpace(evt.getKeyChar()) ){
           //no deja que se escriba un letra
            evt.consume();
            JOptionPane.showMessageDialog(rootPane, "Ingresar solo letras o espacios en blanco");
        }
    }//GEN-LAST:event_jFTBusquedaKeyTyped

    private void btnGenerarReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarReporteActionPerformed
        //Ir al formulario de generar reporte
        FrmVisualizarReporteVigilantes vrp = new FrmVisualizarReporteVigilantes();
        vrp.show();
        dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmVisualizarPersonal().setVisible(true);
            }
        });
    }
